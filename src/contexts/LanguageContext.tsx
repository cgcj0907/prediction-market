...
export const translations = {
  en: {
    ...
    poolNote: "Pool ratio determines payout odds. Winning payouts are proportional to your stake in the winning pool.",
    predictYes: "Predict YES",
    predictNo: "Predict NO",
    predictNote: "You cannot change your prediction once submitted.",
    triggerOracle: "Trigger Settlement Oracle",
    claimWinnings: "Claim Winnings",
    predicting: "Processing...",
    settling: "Settling...",
    claiming: "Claiming...",
    ratioNote: "* Pool ratios reflect current liquidity, not precise probability.",
    ruleNote: "Winning predictions split the losing pool proportionally. Losing predictions forfeit 100% of their stake.",
    // Page
  ...
  zh: {
    ...
    noPool: "NO 资金池",
    totalPool: "总奖池:",
    poolNote: "资金池比例决定了赔率。获胜者将按比例瓜分输家的本金。",
    predictYes: "预测 YES",
    predictNo: "预测 NO",
    predictNote: "下注后无法修改选项。",
    triggerOracle: "触发预言机结算",
    claimWinnings: "提取奖金",
    predicting: "处理中...",
    settling: "结算中...",
    claiming: "提取中...",
    ratioNote: "* 资金池比例反映当前流动性，而非精确概率。",
    ruleNote: "赢家的预测将按比例瓜分输家的资金池。输家的预测将损失 100% 的质押本金。",
    // Page
    marketsTitle: "市场大厅",
    tabLive: "进行中",
    tabSettled: "已结算",
